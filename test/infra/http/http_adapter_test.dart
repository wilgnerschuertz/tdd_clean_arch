...
void main() {
  ...
  group('post', () {
    ...
    test('Should return null if post returns 400 with no data', () async {
    ...
    test('Should return null if post returns 500', () async {
      mockResponse(500);
    ...
    test('Should return null if post throws', () async {
      mockError();
      final future = sut.request(url: url, method: 'post');
